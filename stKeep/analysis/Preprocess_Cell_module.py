...
stKeep.utilities.find_hvgs(args, adata)
...
try:
	...
	annota_clu = pd.read_table(args.outPath + args.annoFile, header=0, index_col=0)
...
hvgs       = pd.read_table(args.inputPath + args.hgvsFile, header=0, index_col=0)
